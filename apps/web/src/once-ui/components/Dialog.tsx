...
import { Flex, Heading, IconButton, Button, type ButtonProps, Text } from ".";
    ...
    return ReactDOM.createPortal(
      <Flex
        ...
        className={classNames(styles.overlay, className, {
          [styles.open as string]: isAnimating,
        })}
        style={style}
      ...
      >
        ...
        >
          ...
          {(primaryButtonProps ||
            ...
            >
              {dangerButtonProps && (
                <Button {...dangerButtonProps} variant="danger" size="m" />
              )}
              <Flex gap="8">
                {secondaryButtonProps && (
                  <Button
                ...
                {primaryButtonProps && (
                  <Button {...primaryButtonProps} variant="primary" size="m" />
                )}
              </Flex>
            </Flex>
          )}
