        ...
        {dots && (
          <div
            ...
            style={{
              ...
              height: "100%",
              backgroundImage:
                "radial-gradient(var(--brand-on-background-weak) 0.5px, var(--static-transparent) 0.5px)",
              opacity: "0.25",
        ...
        {lines && (
          <div
            ...
            style={{
              ...
              height: "100%",
              backgroundImage:
                "repeating-linear-gradient(45deg, var(--brand-on-background-weak) 0, var(--brand-on-background-weak) 0.5px, var(--static-transparent) 0.5px, var(--static-transparent) var(--static-space-8))",
              maskImage:
                "linear-gradient(to bottom left, rgba(0, 0, 0, 1) 30%, rgba(0, 0, 0, 0) 70%)",
              maskSize: "100% 100%",
          ...
          stars.map((star) => (
            <div
              ...
              style={{
                ...
                height: "1px",
                background:
                  "linear-gradient(to right, rgba(255, 255, 255, 1), rgba(255, 255, 255, 0))", // Horizontal gradient for trail
